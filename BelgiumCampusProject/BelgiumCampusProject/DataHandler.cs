...
namespace BelgiumCampusProject
{
    ...
    {
        public DataHandler() { }                       //catalog is database name
        static string connect = "Data Source=.; Initial Catalog= BelgiumCampus; Integrated Security=SSPI;";
        ...
        //read or display student method
